...
if __name__ == "__main__":
    ...
    console.print("[bold yellow][!] Note[/bold yellow]: original speed cannot be restored!")
    console.print("[bold cyan][!] Enter Car Details.[/bold cyan]")

    car_id = IntPrompt.ask("[bold][?] Car ID[/bold]")
    
    console.print("[bold cyan][%] Hacking Car Speed...[/bold cyan]")
    ...
    if cpm.hack_car_speed(car_id):
        ...
        sleep(2)
        continue  # Restart loop after failure
